...
### 🌐 多模态编码系统
- ArcticVisionEncoder：NaViT 原生分辨率（最高 1024px）
- ArcticVideoEncoder：时序视觉、帧级注意力
- ArcticAudioEncoder：高级音频特征提取
- ArcticDocEncoder：文档结构理解（LayoutLMv3）
- ArcticAgenticEncoder：智能体行为建模（兼容性包装器）
