"""
Benchmarking and performance analysis tools for quantized models.

This module provides comprehensive benchmarking capabilities to evaluate
quantized model performance, including inference speed, memory usage,
accuracy metrics, and comparison with baseline models.
"""
