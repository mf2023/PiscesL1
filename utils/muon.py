...
#
# Muon Optimizer — orthogonalized momentum for faster MoE training.
# Reference: DeepSeek-V4 technical report, section on Muon optimizer.
# First verified deployment on trillion-parameter MoE models.
