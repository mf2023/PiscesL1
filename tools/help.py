...
def help():
    ...
    print("    --enable_opss                 Enable OPSS integration (MCP Plaza, Swarm, Orchestrator)")
    print("    --enable_agent_intercept      Enable agent XML pattern interception")
    ...
    print("")
    print("  Agent XML Patterns (when --enable_agent_intercept):")
    ...
    print("    control <run_id> <action>     Send control command (pause/resume/cancel/save_ckpt_now)")
    ...
    print("  python manage.py serve --model_size 72B --enable_opss --enable_agent_intercept")
